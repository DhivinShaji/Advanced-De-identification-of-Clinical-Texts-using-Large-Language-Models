...
class NER_BioBERT2(object):
    ...
    def evaluate(self, X_test, Y_test):
        ...
        # Ensure valid_tags and pred_tags are lists of lists
        pred_tags = [[self.tag_values[p_i] for p_i in p if self.tag_values[p_i] != "PAD"] for p in predictions]
        valid_tags = [[self.tag_values[l_i] for l_i in l if self.tag_values[l_i] != "PAD"] for l in true_labels]
